...
>
> **This project is completely generated by AI**, including its code, documentation, tests, architecture, and implementation decisions. It may contain mistakes, unsafe assumptions, or unexpected behavior. Review the code yourself before using it, especially with a real Granblue Fantasy account.
