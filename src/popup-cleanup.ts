...
if (footer) {
  footer.textContent = 'Dashboard access is always available. Manual Start/Stop remains under Developer; Raw Capture, account reset and local-storage cleanup are in Dashboard Settings.';
}
